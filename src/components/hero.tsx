...
const techButtons = [
  ...
  { label: "React Native", icon: <SiReact /> }, // Same icon as React
  ...
  { label: "Kaggle", icon: <SiKaggle /> },
  { label: "spaCy", icon: <SiSpacy /> }, // No official icon in react-icons; you can use a fallback
];
